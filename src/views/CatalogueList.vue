<template>
  <div class="col-md-11 m-auto mx-3 mb-3" style="padding-top: 2rem !important">
    <div class="row my-3">
      ...
      <div class="col-md-6" style="text-align: left">
        ...
        <p style="font-weight: 700; font-size: 13px">
          MRP: <span style="color: grey">₹ {{ this.mrp }}</span>
        </p>
...
export default {
  created() {
    ...
    this.categoryname = JSON.parse(
      localStorage.getItem("expandFashion")
    ).category_name;
  ...
  data() {
    return {
      indexOfActive: 0,
      activePic: JSON.parse(localStorage.getItem("expandFashion")).img_url,
      pictures: [JSON.parse(localStorage.getItem("expandFashion")).img_url],
      categoryname: "",
      itemname: "",
      mrp: "",
    };
      ...
      if (localStorage.getItem("cartId") == null) {
        ...
        axios
          ...
          .then((response) => {
            ...
            console.log(
              "successfully added first item with cart id",
        ...
        axios
          ...
          .then((response) => {
            console.log(
              "successfully added next item with cart id",
              localStorage.getItem("cartId")
            );
            localStorage.setItem("cartId", response.data.cartId);
            this.$router.push("/cart");
